...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(BomberQuestGame game) {
        ...
        camera.zoom = 1.8f; // Set camera zoom for a closer view
        ...
        table.add(new Label("Ho ho ho, and welcome to Santa´s Blast Factory!", game.getSkin(), "title")).padBottom(80).row();
